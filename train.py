...
images = glob.glob(train_images + "*.jpg") + glob.glob(
    train_images + "*.png") + glob.glob(train_images + "*.jpeg")
num_train = len(images)

images = glob.glob(val_images + "*.jpg") + glob.glob(
    val_images + "*.png") + glob.glob(val_images + "*.jpeg")
num_val = len(images)
